 ...
 */
vkr_internal void
vkr_bindless_vk_report_upload_exhaustion(VkrBindlessVulkanRenderer *renderer,
                                         const VkrBindlessVkFrameSlot *slot) {
...
vkr_internal bool8_t vkr_bindless_vk_record_draw(
  ...
  if (!vkr_bindless_vk_prepare_packet_uploads(renderer, slot,
    ...
    vkr_bindless_vk_report_upload_exhaustion(renderer, slot);
    return false_v;
  }
