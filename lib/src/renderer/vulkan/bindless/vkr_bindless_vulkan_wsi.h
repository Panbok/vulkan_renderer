...
/** State proven by reacquiring an image that was previously presented. */
...
/**
 * Records the unextended WSI completion proof. Reacquiring a previously
 * presented image proves that presentation and its binary wait complete. If
 * this is a successor swapchain, the same proof permits predecessor collection.
 */
VkrBindlessVulkanReacquireResult
