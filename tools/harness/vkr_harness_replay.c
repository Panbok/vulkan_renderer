...
static const VkrHarnessCaptureChannelDescription s_channels[] = {
    ...
    {"gtao_view_depth", "gtao_view_depth", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    {"gtao_raw", "gtao_raw", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"ssr_depth", "ssr_depth", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"ssr_raw", "ssr_raw", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"ssr_reflection", "ssr_reflection", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"gtao_visibility", "gtao_visibility", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    ...
    {"transmission_visibility_ids_layer_1",
     "transmission_visibility_ids_layer_1", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    {"transmission_visibility_ids_layer_2",
     "transmission_visibility_ids_layer_2", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    {"transmission_visibility_ids_layer_3",
     "transmission_visibility_ids_layer_3", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    {"transmission_visibility_ids_layer_4",
     "transmission_visibility_ids_layer_4", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    {"hdr_pre_bloom", "hdr_pre_bloom", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"bloom_prefilter", "bloom_prefilter", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    {"bloom_result", "bloom_result", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"hdr_combined", "hdr_combined", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"hdr_pre_transmission", "hdr_pre_transmission", "direct",
     VKR_RENDER_MODE_DEFAULT, 0u},
    {"hdr_post_transmission", "hdr_post_transmission", "direct",
     VKR_RENDER_MODE_DEFAULT, 0u},
    {"dof_color", "dof_color", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"dof_coc", "dof_coc", "direct", VKR_RENDER_MODE_DEFAULT, 0u},
    {"subsurface_color", "subsurface_color", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    {"subsurface_diffuse", "subsurface_diffuse", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    {"motion_blur_color", "motion_blur_color", "direct",
     VKR_RENDER_MODE_DEFAULT, 0u},
    {"motion_blur_tiles", "motion_blur_tiles", "direct",
     VKR_RENDER_MODE_DEFAULT, 0u},
    {"motion_vectors", "motion_vectors", "direct", VKR_RENDER_MODE_DEFAULT,
     0u},
    ...
    {"detail_lighting", "final_color", "detail_lighting",
     VKR_RENDER_MODE_DETAIL_LIGHTING, 0u},
    {"lighting_only", "final_color", "lighting_only",
     VKR_RENDER_MODE_LIGHTING_ONLY, 0u},
    {"wireframe", "final_color", "wireframe", VKR_RENDER_MODE_WIREFRAME, 0u},
    ...
    /* Environment diffuse only; the channel that isolates the SH response
       (ADR-038). Bloom and temporal accumulation are resolved off for this
       mode at the packet boundary. */
