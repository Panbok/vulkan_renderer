...
3a. Complete ADR-038's retained acceptance evidence. The final SH L2 diffuse
   ...
   captures on each backend, but the Vulkan payload was not retained for a
   numeric comparison. Deterministic GPU projection-fixture repetition, the
   retained pixel comparison, café-probe owner review, submitted-frame
