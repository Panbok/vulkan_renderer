...
| [shadow-cpu-cost-and-csm-rewrite-spec.md](rendering/shadow-cpu-cost-and-csm-rewrite-spec.md) | partial | P0/P1, the P2 candidate-generation substrate, P3 retained per-image cascade reuse, and P7 receiver quality ship. Metal tap/early-out and lambda/map-size experiments retain the current defaults; proactive refresh, two-phase visibility, and SDSM feedback remain proposed |
