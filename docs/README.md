...
| Document | Status | Purpose |
|---|---|---|
| [image-quality-roadmap.md](rendering/image-quality-roadmap.md) | partial | **Ordered plan for image-quality work.** Presentation correctness, portable same-resolution TAA, stationary transparency accumulation, and post-TAA FXAA ship; held and moving-camera captures, matched local pass timing, and RX 6700 XT validation pass. Native Apple validation, authored transparent/deformation motion, broader animation/disocclusion fixtures, automatic exposure, bloom, and GTAO remain open; MSAA is outside the implemented slice |
