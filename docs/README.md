...
| [shadow-cpu-cost-and-csm-rewrite-spec.md](rendering/shadow-cpu-cost-and-csm-rewrite-spec.md) | proposed | Directional shadow cost and quality: measurement gate, itemized quality gap against nuri, persistent candidate residency, caster-fitted light-space Z, static-only cascade reuse, occlusion-culling repair, SDSM, and PCF restore |
