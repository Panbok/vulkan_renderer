...
| [shadow-cpu-cost-and-csm-rewrite-spec.md](rendering/shadow-cpu-cost-and-csm-rewrite-spec.md) | partial | P0/P1, the P2 candidate-generation substrate, and P3 retained per-image cascade reuse ship; proactive refresh, two-phase visibility, SDSM feedback, and unit-defined PCF quality remain proposed |
