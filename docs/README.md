...
| [038](architecture/adr/038-sh-l2-diffuse-irradiance.md) | partial | Final packet-version-23 Metal/Vulkan implementation replaces the baked diffuse cubemap with GPU-resident second-order SH coefficients for `E/pi` in completion-safe slots; source, skybox, and specular-prefilter cubemaps remain. Native Vulkan, matched quality, lifetime-stress, and authoritative performance acceptance evidence remains open |
