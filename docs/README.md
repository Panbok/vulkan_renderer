...
| [shadow-cpu-cost-and-csm-rewrite-spec.md](rendering/shadow-cpu-cost-and-csm-rewrite-spec.md) | partial | P0/P1, the P2 candidate substrate, P3 retained cascade reuse, and P7 receiver quality ship. P4 closed without a topology change; bounded P5 refresh and Metal P6 SDSM ship opt-in and default off; Vulkan SDSM lowering remains open |
