...
| Publication | Cold load/finalization operation that makes prepared assets resolvable to the selected renderer. | [vkr_asset_publisher.h](../renderer/src/vkr_asset_publisher.h) |
...
| Picking | Rendering/reading object IDs to resolve a selection in Scene viewport coordinates. | [vkr_frame_input.h](../renderer/src/vkr_frame_input.h) |
