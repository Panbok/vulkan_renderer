...
vkr_internal void test_editor_viewport_mapping(void) {
  ...
  assert(MemCompare(&mapping.image_rect_px, &mapping.panel_rect_px,
  ...
  assert(MemCompare(&payload.image_rect_px, &mapping.image_rect_px,
  ...
  assert(MemCompare(&mapping.panel_rect_px, &dock_panel, sizeof(dock_panel)) ==
         0);
...
vkr_internal void test_editor_viewport_packet_validation(void) {
...
vkr_internal void test_scene_output_extent_restore(void) {
