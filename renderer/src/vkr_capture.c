...
enum {
  ...
  VKR_CAPTURE_CHANNEL_SSR_DEPTH,
  VKR_CAPTURE_CHANNEL_SSR_RAW,
  VKR_CAPTURE_CHANNEL_SSR_REFLECTION,
  VKR_CAPTURE_CHANNEL_DOF_COLOR,
  VKR_CAPTURE_CHANNEL_DOF_COC,
  VKR_CAPTURE_CHANNEL_MOTION_BLUR_COLOR,
  VKR_CAPTURE_CHANNEL_MOTION_BLUR_TILES,
  VKR_CAPTURE_CHANNEL_MOTION_VECTORS,
  VKR_CAPTURE_CHANNEL_SUBSURFACE_COLOR,
  VKR_CAPTURE_CHANNEL_SUBSURFACE_DIFFUSE,
};
...
vkr_global const VkrCaptureChannelDescription s_capture_channels[] = {
    ...
    {VKR_CAPTURE_CHANNEL_HDR_PRE_BLOOM, "hdr_pre_bloom",
     ...
     VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE", 3},
    ...
    {VKR_CAPTURE_CHANNEL_GTAO_RAW, "gtao_raw", "gtao_raw",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_NONE, "RGBA8_UNORM_PNG",
     2},
    ...
    {VKR_CAPTURE_CHANNEL_HDR_POST_TRANSMISSION, "hdr_post_transmission",
     ...
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE",
     2},
    {VKR_CAPTURE_CHANNEL_SSR_DEPTH, "ssr_depth", "ssr_depth_pyramid",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_DEPTH, VKR_CAPTURE_COLOR_SPACE_NONE, "R32_FLOAT_LE", 1},
    {VKR_CAPTURE_CHANNEL_SSR_RAW, "ssr_raw", "ssr_raw",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE",
     2},
    {VKR_CAPTURE_CHANNEL_SSR_REFLECTION, "ssr_reflection", "ssr_history_color",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE",
     5},
    {VKR_CAPTURE_CHANNEL_DOF_COLOR, "dof_color", "dof_composite",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE",
     2},
    {VKR_CAPTURE_CHANNEL_DOF_COC, "dof_coc", "dof_coc",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_NONE, "RG16_FLOAT_LE", 1},
    {VKR_CAPTURE_CHANNEL_MOTION_BLUR_COLOR, "motion_blur_color",
     "motion_blur_color", VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE",
     2},
    {VKR_CAPTURE_CHANNEL_MOTION_BLUR_TILES, "motion_blur_tiles",
     "motion_blur_neighbor_max", VKR_CAPTURE_FEATURE_NONE,
     VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_NONE, "RG16_FLOAT_LE", 1},
    {VKR_CAPTURE_CHANNEL_MOTION_VECTORS, "motion_vectors", "temporal_motion",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_NONE, "RG16_FLOAT_LE", 1},
    {VKR_CAPTURE_CHANNEL_SUBSURFACE_COLOR, "subsurface_color",
     "subsurface_color", VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE",
     1},
    {VKR_CAPTURE_CHANNEL_SUBSURFACE_DIFFUSE, "subsurface_diffuse",
     "subsurface_diffuse", VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR,
     VKR_CAPTURE_VALUE_COLOR, VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE",
     1},
