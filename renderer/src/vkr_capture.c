...
vkr_global const VkrCaptureChannelDescription s_capture_channels[] = {
    ...
    {VKR_CAPTURE_CHANNEL_DOF_COLOR, "dof_color", "dof_composite",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE", 2},
    {VKR_CAPTURE_CHANNEL_DOF_COC, "dof_coc", "dof_coc",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_NONE, "RG16_FLOAT_LE", 1},
    {VKR_CAPTURE_CHANNEL_MOTION_BLUR_COLOR, "motion_blur_color", "motion_blur_color",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE", 2},
    {VKR_CAPTURE_CHANNEL_MOTION_BLUR_TILES, "motion_blur_tiles", "motion_blur_neighbor_max",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_NONE, "RG16_FLOAT_LE", 1},
    {VKR_CAPTURE_CHANNEL_MOTION_VECTORS, "motion_vectors", "temporal_motion",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_NONE, "RG16_FLOAT_LE", 1},
    {VKR_CAPTURE_CHANNEL_SUBSURFACE_COLOR, "subsurface_color", "subsurface_color",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE", 1},
    {VKR_CAPTURE_CHANNEL_SUBSURFACE_DIFFUSE, "subsurface_diffuse", "subsurface_diffuse",
     VKR_CAPTURE_FEATURE_NONE, VKR_CAPTURE_ASPECT_COLOR, VKR_CAPTURE_VALUE_COLOR,
     VKR_CAPTURE_COLOR_SPACE_LINEAR, "RGBA16_FLOAT_LE", 1},
