...
typedef struct VkrApplicationMetricsSnapshot {
  float64_t ui_dirty_tile_ratio;
  uint64_t ui_dirty_tiles;
  ...
  uint64_t material_texture_stream_in_flight;
  uint64_t material_texture_stream_resident;
  uint64_t material_texture_stream_evicted;
  uint64_t material_texture_stream_resident_bytes;
  uint64_t material_texture_stream_budget_bytes;
  uint64_t material_texture_stream_applied;
  uint64_t material_texture_stream_failed;
  uint64_t material_texture_stream_evicted_total;
  uint64_t material_texture_stream_pressure_stalls;
  uint64_t material_texture_stream_automatic_pressure_active;
} VkrApplicationMetricsSnapshot;

typedef struct VkrRendererMetricsCollectContext {
  VkrApplicationMetricsSnapshot application;
