...
typedef enum VkrRgJsonConditionKind {
  ...
  VKR_RG_JSON_CONDITION_SKINNING_ENABLED,
  ...
  VKR_RG_JSON_CONDITION_CLEARCOAT_ENABLED,
  VKR_RG_JSON_CONDITION_SHEEN_ENABLED,
  VKR_RG_JSON_CONDITION_ANISOTROPY_ENABLED,
  ...
  VKR_RG_JSON_CONDITION_ATMOSPHERE_ENABLED,
  VKR_RG_JSON_CONDITION_AERIAL_PERSPECTIVE_ENABLED,
  VKR_RG_JSON_CONDITION_CLOUDS_ENABLED,
  ...
  VKR_RG_JSON_CONDITION_FSR31_ENABLED,
  VKR_RG_JSON_CONDITION_FSR31_DISABLED,
...
typedef enum VkrRgJsonImageFormatSource {
  ...
  VKR_RG_JSON_IMAGE_FORMAT_SWAPCHAIN_DEPTH,
  VKR_RG_JSON_IMAGE_FORMAT_SHADOW_DEPTH,
