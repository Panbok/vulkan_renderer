...
vkr_global const VkrMetalPacketAbiField vkr_froxel_inject_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketFroxelInjectRoot, history_texture_id, "history",
                  16),
    VKR_ABI_FIELD(VkrMetalPacketFroxelInjectRoot, output_texture_id, "output",
                  24),
...
vkr_global const VkrMetalPacketAbiField vkr_subsurface_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSubsurfaceRoot, inverse_view_projection,
                  "inverse_view_projection", 32),
    VKR_ABI_FIELD(VkrMetalPacketSubsurfaceRoot, frame, "frame", 96),
    VKR_ABI_FIELD(VkrMetalPacketSubsurfaceRoot, visible_rows, "visible_rows",
                  104),
    ...
    VKR_ABI_FIELD(VkrMetalPacketSubsurfaceRoot, profile_bank, "profile_bank",
                  152),
    ...
    VKR_ABI_FIELD(VkrMetalPacketSubsurfaceRoot, destination, "destination",
                  200),
};
...
vkr_global const VkrMetalPacketAbiField vkr_motion_blur_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketMotionBlurRoot, destination0, "destination0",
                  88),
};
...
vkr_global const VkrMetalPacketAbiField vkr_ssgi_params_fields[] = {
    ...
    VKR_ABI_FIELD(VkrSsgiGpuParams, inverse_projection, "inverse_projection",
                  64),
    ...
    VKR_ABI_FIELD(VkrSsgiGpuParams, trace_texel_size_x, "trace_texel_size_x",
                  272),
    VKR_ABI_FIELD(VkrSsgiGpuParams, trace_texel_size_y, "trace_texel_size_y",
                  276),
    VKR_ABI_FIELD(VkrSsgiGpuParams, history_jitter_uv_x, "history_jitter_uv_x",
                  280),
    VKR_ABI_FIELD(VkrSsgiGpuParams, history_jitter_uv_y, "history_jitter_uv_y",
                  284),
};
...
vkr_global const VkrMetalPacketAbiField vkr_ssgi_depth_base_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsgiDepthBaseRoot, depth_texture_id, "depth",
                  288),
    VKR_ABI_FIELD(VkrMetalPacketSsgiDepthBaseRoot, vbuffer_texture_id,
                  "vbuffer", 296),
    VKR_ABI_FIELD(VkrMetalPacketSsgiDepthBaseRoot, pyramid_texture_id,
                  "pyramid", 304),
    VKR_ABI_FIELD(VkrMetalPacketSsgiDepthBaseRoot, receiver_texture_id,
                  "receiver", 312),
};
...
vkr_global const VkrMetalPacketAbiField vkr_ssgi_depth_mip_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsgiDepthMipRoot, source_texture_id, "source",
                  288),
    VKR_ABI_FIELD(VkrMetalPacketSsgiDepthMipRoot, destination_texture_id,
                  "destination", 296),
    VKR_ABI_FIELD(VkrMetalPacketSsgiDepthMipRoot, source_extent,
                  "source_extent", 304),
    VKR_ABI_FIELD(VkrMetalPacketSsgiDepthMipRoot, destination_extent,
...
vkr_global const VkrMetalPacketAbiField vkr_ssgi_trace_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsgiTraceRoot, vbuffer_texture_id, "vbuffer",
                  296),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTraceRoot, normal_texture_id, "normal",
                  304),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTraceRoot, albedo_texture_id, "albedo",
                  312),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTraceRoot, pyramid_texture_id, "pyramid",
                  320),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTraceRoot, direct_source_texture_id,
                  "direct_source", 328),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTraceRoot, raw_texture_id, "raw", 336),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTraceRoot, receiver_texture_id, "receiver",
                  344),
};
...
vkr_global const VkrMetalPacketAbiField vkr_ssgi_temporal_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, vbuffer_texture_id, "vbuffer",
                  296),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, depth_texture_id, "depth",
                  304),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, normal_texture_id, "normal",
                  312),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, motion_texture_id, "motion",
                  320),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, validity_texture_id,
                  "validity", 328),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, history_color_texture_id,
                  "history_color", 336),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, history_depth_texture_id,
                  "history_depth", 344),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, history_identity_texture_id,
                  "history_identity", 352),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, output_color_texture_id,
                  "output_color", 360),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, output_depth_texture_id,
                  "output_depth", 368),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, output_identity_texture_id,
                  "output_identity", 376),
    VKR_ABI_FIELD(VkrMetalPacketSsgiTemporalRoot, visible_rows, "visible_rows",
                  384),
...
vkr_global const VkrMetalPacketAbiField vkr_ssgi_composite_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, history_color_texture_id,
                  "history_color", 312),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, vbuffer_texture_id,
                  "vbuffer", 320),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, depth_texture_id, "depth",
                  328),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, albedo_texture_id, "albedo",
                  336),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, normal_texture_id, "normal",
                  344),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, history_depth_texture_id,
                  "history_depth", 352),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, specular_texture_id,
                  "specular", 360),
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, anisotropy_texture_id,
                  "anisotropy", 464),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, visible_rows, "visible_rows",
                  480),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, subsurface_profile_count,
                  "subsurface_profile_count", 440),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, subsurface_source_texture_id,
                  "subsurface_source", 488),
    VKR_ABI_FIELD(VkrMetalPacketSsgiCompositeRoot, receiver_texture_id,
                  "receiver", 496),
};
...
vkr_global const VkrMetalPacketAbiField vkr_ssr_reprojection_params_fields[] = {
    VKR_ABI_FIELD(VkrSsrReprojectionGpuParams, inverse_view, "inverse_view", 0),
    VKR_ABI_FIELD(VkrSsrReprojectionGpuParams, previous_view, "previous_view",
                  64),
};
...
vkr_global const VkrMetalPacketAbiField vkr_ssr_depth_base_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsrDepthBaseRoot, depth_texture_id, "depth",
                  288),
    VKR_ABI_FIELD(VkrMetalPacketSsrDepthBaseRoot, vbuffer_texture_id, "vbuffer",
                  296),
    VKR_ABI_FIELD(VkrMetalPacketSsrDepthBaseRoot, pyramid_texture_id, "pyramid",
                  304),
};
...
vkr_global const VkrMetalPacketAbiField vkr_ssr_trace_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsrTraceRoot, vbuffer_texture_id, "vbuffer",
                  296),
    VKR_ABI_FIELD(VkrMetalPacketSsrTraceRoot, normal_texture_id, "normal", 304),
    VKR_ABI_FIELD(VkrMetalPacketSsrTraceRoot, specular_texture_id, "specular",
                  312),
    VKR_ABI_FIELD(VkrMetalPacketSsrTraceRoot, pyramid_texture_id, "pyramid",
                  320),
    VKR_ABI_FIELD(VkrMetalPacketSsrTraceRoot, hdr_texture_id, "hdr", 328),
    VKR_ABI_FIELD(VkrMetalPacketSsrTraceRoot, raw_texture_id, "raw", 336),
    VKR_ABI_FIELD(VkrMetalPacketSsrTraceRoot, clearcoat_texture_id, "clearcoat",
                  344),
    VKR_ABI_FIELD(VkrMetalPacketSsrTraceRoot, hit_texture_id, "hit", 352),
};
...
vkr_global const VkrMetalPacketAbiField vkr_ssr_temporal_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, vbuffer_texture_id, "vbuffer",
                  296),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, depth_texture_id, "depth",
                  304),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, normal_texture_id, "normal",
                  312),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, history_color_texture_id,
                  "history_color", 320),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, history_depth_texture_id,
                  "history_depth", 328),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, history_identity_texture_id,
                  "history_identity", 336),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, output_color_texture_id,
                  "output_color", 344),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, output_depth_texture_id,
                  "output_depth", 352),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, output_identity_texture_id,
                  "output_identity", 360),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, visible_rows, "visible_rows",
                  368),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, instances, "instances", 376),
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, clearcoat_texture_id,
                  "clearcoat", 392),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, hit_texture_id, "hit", 400),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, previous_transforms,
                  "previous_transforms", 408),
    VKR_ABI_FIELD(VkrMetalPacketSsrTemporalRoot, reprojection, "reprojection",
                  416),
...
vkr_global const VkrMetalPacketAbiField vkr_ssr_composite_root_fields[] = {
    ...
    VKR_ABI_FIELD(VkrMetalPacketSsrCompositeRoot, history_color_texture_id,
                  "history_color", 312),
    VKR_ABI_FIELD(VkrMetalPacketSsrCompositeRoot, vbuffer_texture_id, "vbuffer",
                  320),
    VKR_ABI_FIELD(VkrMetalPacketSsrCompositeRoot, depth_texture_id, "depth",
                  328),
    VKR_ABI_FIELD(VkrMetalPacketSsrCompositeRoot, albedo_texture_id, "albedo",
                  336),
    VKR_ABI_FIELD(VkrMetalPacketSsrCompositeRoot, specular_texture_id,
                  "specular", 344),
    VKR_ABI_FIELD(VkrMetalPacketSsrCompositeRoot, normal_texture_id, "normal",
                  352),
...
vkr_global const VkrMetalPacketAbiField vkr_temporal_transform_fields[] = {
    VKR_ABI_FIELD(VkrTemporalTransformGPU, model, "model", 0),
    VKR_ABI_FIELD(VkrTemporalTransformGPU, generation, "generation", 64),
    VKR_ABI_FIELD(VkrTemporalTransformGPU, frame_index, "frame_index", 68),
    VKR_ABI_FIELD(VkrTemporalTransformGPU, valid, "valid", 72),
...
vkr_global const VkrMetalPacketAbiRecord
    vkr_metal_packet_abi_records[VKR_METAL_PACKET_ABI_RECORD_COUNT] = {
        ...
        [VKR_METAL_PACKET_ABI_SSR_DEPTH_MIP_ROOT] = VKR_ABI_RECORD(
            VkrMetalPacketSsrDepthMipRoot, "VkrMetalPacketSsrDepthMipRoot", 320,
            16, vkr_ssr_depth_mip_root_fields),
        ...
        [VKR_METAL_PACKET_ABI_SSR_TEMPORAL_ROOT] = VKR_ABI_RECORD(
            VkrMetalPacketSsrTemporalRoot, "VkrMetalPacketSsrTemporalRoot", 432,
            16, vkr_ssr_temporal_root_fields),
        ...
        [VKR_METAL_PACKET_ABI_SUBSURFACE_PARAMS] =
            VKR_ABI_RECORD(VkrSubsurfaceGpuParams, "VkrSubsurfaceGpuParams", 32,
                           16, vkr_subsurface_params_fields),
        [VKR_METAL_PACKET_ABI_SUBSURFACE_ROOT] = VKR_ABI_RECORD(
            VkrMetalPacketSubsurfaceRoot, "VkrMetalPacketSubsurfaceRoot", 208,
            16, vkr_subsurface_root_fields),
        [VKR_METAL_PACKET_ABI_MOTION_BLUR_PARAMS] =
            VKR_ABI_RECORD(VkrMotionBlurGpuParams, "VkrMotionBlurGpuParams", 48,
                           16, vkr_motion_blur_params_fields),
        [VKR_METAL_PACKET_ABI_MOTION_BLUR_ROOT] = VKR_ABI_RECORD(
            VkrMetalPacketMotionBlurRoot, "VkrMetalPacketMotionBlurRoot", 96,
            16, vkr_motion_blur_root_fields),
        [VKR_METAL_PACKET_ABI_DOF_PARAMS] = VKR_ABI_RECORD(
            VkrDofGpuParams, "VkrDofGpuParams", 48, 16, vkr_dof_params_fields),
        [VKR_METAL_PACKET_ABI_DOF_ROOT] =
            VKR_ABI_RECORD(VkrMetalPacketDofRoot, "VkrMetalPacketDofRoot", 112,
                           16, vkr_dof_root_fields),
